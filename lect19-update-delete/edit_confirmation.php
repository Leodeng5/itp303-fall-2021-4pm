...
if ( !isset($_POST['track_name']) || empty($_POST['track_name']) 
	...
	// bind_param()
	// 1st param: data types of each placeholder
	// the rest of param are the user input
	...
	// affected_rows tells us how many records were updated, deleted or inserted. we should be only getting 1!
